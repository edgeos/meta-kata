#From https://git.yoctoproject.org/git/meta-security  @4d139b95c4f152d132592f515c5151f4dd6269c1
...
# Added by Yonatan Gefen 7/17/18:
RDEPENDS_${PN} += " libtool libxml2 libxslt openssl zlib libgcrypt gnutls nss nspr libgpg-error "
